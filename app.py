...
if not st.session_state.connecte:
    ...
    if st.session_state.page_active == "PresenceGeo":
        ...
        st.markdown(
            "<p style='text-align: center; color: #9ca3af; margin-bottom: 40px;'>De l'audit stratégique à la cybersécurité, nous couvrons l'ensemble de vos besoins informatiques.</p>",
            unsafe_allow_html=True,
        )
